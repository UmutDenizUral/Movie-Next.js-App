...
//   try {
//     const movieResponse = await axios.get(`https://api.themoviedb.org/3/tv/${id}`, {
//       params: {
//         api_key: process.env.API_KEY,
//       },
//     });

//     const castResponse = await axios.get(`https://api.themoviedb.org/3/tv/${id}/credits`, {
//       params: {
//         api_key: process.env.API_KEY,
//       },
//     });

//     const similarMoviesResponse = await axios.get(`https://api.themoviedb.org/3/tv/${id}/similar`, {
//       params: {
//         api_key: process.env.API_KEY,
//         language: 'en-US',
//         page: 1,
...
//         <div className="mt-10">
//           <h2 className="text-3xl font-bold mb-6">Benzer Diziler</h2>
//           <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
//             {similarMovies.map((similarMovie) => (
//               <div key={similarMovie.id} className="relative">
//                 <Link href={`/series/${similarMovie.id}`}>
